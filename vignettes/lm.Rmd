...
The aim of this vignette is to demonstrate how to use the two key functions of `dsmcmc`, `mcmc_to_dt()` and `tidy` (which actually calls `dsmcmc:::tidy.mcmc.list` under the hood).
