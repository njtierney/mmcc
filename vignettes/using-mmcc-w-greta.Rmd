...
Explore the different chains with different colours
...
Or explore the different chains across facets

```{r ggplot2-examples-facet-wrap-chain}
# explore the different chains across facets
ggplot(neat_draws[parameter == "int"],
       aes(x = iteration,
           y = value)) + 
  geom_line() + 
...
Exploring the variation in the `sd` parameter

```{r ggplot2-examples-colour-density-sd}
...
```{r ggplot2-examples-colour-density-coef}
